defmodule TodoListAppWeb.Router do
  ...
  import TodoListAppWeb.UserAuth
  ...
  scope "/", TodoListAppWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TodoListAppWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TodoListAppWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TodoListAppWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TodoListAppWeb do
    ...
    live_session :current_user,
      on_mount: [{TodoListAppWeb.UserAuth, :mount_current_user}] do
